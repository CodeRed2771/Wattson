...
public class Calibration {
	...
	public static final double GEAR_PICKUP_ARM_PARK = -.1; // competition
	public static final double GEAR_PICKUP_ARM_VERTICAL = 0; // competition bot
	public static final double GEAR_PICKUP_ARM_HORIZONTAL = .25; //competition
